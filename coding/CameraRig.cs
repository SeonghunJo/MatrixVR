...
#region Unity Messages
...
#endif
	{
		...
		//Debug.Log("RightEyeAnchor : " + rightEyeAnchor.position);
		//Debug.Log("RightEyeAnchor : " + rightEyeAnchor.position);
		Debug.Log("RightEyePosition z : " + rightEyeAnchor.rotation.z);
		Debug.Log("RightEyePosition w : " + rightEyeAnchor.rotation.w);
		//Debug.Log("RightEyePosition : " + rightEyeAnchor.rotation.z);
		//Debug.Log("RightEyePosition : " + rightEyeAnchor.rotation.w);
		//Console.WriteLine("{0},{1},{2},{3}",rightEyeAnchor.rotation.w,rightEyeAnchor.rotation.x,rightEyeAnchor.rotation.y,rightEyeAnchor.rotation.z);
	}
